This is a testing ground for programs that play computer go, creating a bridge via the "Go Text Protocol":http://www.lysator.liu.se/~gunnar/gtp/gtp2-spec-draft2/gtp2-spec.html.
